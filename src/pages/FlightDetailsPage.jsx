  ...
  return (
    <div style={styles.container}>
      <div style={styles.wrapper}>
        ...
        <div className="mb-6 p-4 rounded-2xl bg-white text-slate-800 flex items-center justify-between border border-blue-100 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600">
              <Sparkles className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-extrabold uppercase text-blue-800 tracking-wider">
                Live Price Tracking
              </h4>
              <p className="text-xs text-slate-500 font-semibold mt-0.5">
                {frozenObj ? (
                  ...
                  `Current fare breakdown: Standard fare ₹${baseFare.toLocaleString('en-IN')}${surgeAmount > 0 ? ` + High demand fee ₹${surgeAmount.toLocaleString('en-IN')}` : ''}`
                )}
              </p>
            </div>
          </div>
          ...
          <div className="text-right">
            <span className="text-[11px] text-slate-500 block font-medium">Your Total Fare</span>
